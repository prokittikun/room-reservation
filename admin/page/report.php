...
$sql .= "ORDER BY reservations.create_at LIMIT ?,?";
...
$route_params = get_params_isNotEmpty([
    'r' => $r, 'start_dt' => $start_dt,
    'end_dt' => $end_dt, 'status' => $status,
        ...
        <table class="m-0 table table-hover" style="width: 1600px;">
            <thead>
                <tr>
                    ...
                    <th style="width:21%;" scope="col">ห้อง</th>
                    <th style="width: 6%;" scope="col">เบอร์</th>
                    <th style="width: 17%;" scope="col">ชื่อ - นามสกุล</th>
...
?>
<script src="./js/findDataByDate.js"></script>
